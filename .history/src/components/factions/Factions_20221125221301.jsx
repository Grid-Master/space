...
const Factions = () => {
  ...
  return (
    <section className="factions">
      ...
      <Modal active={activeFaction} setActive={setActiveFaction} background="skycitadel">
        {/* {factionLocations.map((factionLocation, index) => (
          <FactionModal setActiveFaction={setActiveFaction} {...factionLocation} key={index} />
        ))} */}
        <FactionModal setActiveFaction={setActiveFaction} {...factionLocations[3]} />
        {/* <FactionModal setActiveFaction={setActiveFaction} {...factionLocations[1]} /> */}
      </Modal>
    </section>
  );
};
