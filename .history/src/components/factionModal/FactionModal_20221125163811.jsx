...
import img from '../../assets/images/factionModal/Badlands/imgBadlands.png';
import img from '../../assets/images/factionModal/Badlands/bgBadlands.png';

const FactionModal = ({ activeFaction, setActiveFaction }) => {
  return (
    <div className="factionModal">
